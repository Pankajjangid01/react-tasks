...
const Task1 = () => {
  ...
  return (
    <div className="flex justify-center">
      <div className="bg-yellow-100 rounded-lg p-6 w-[550px] shadow-lg shadow-[#9a968b] flex flex-col items-center gap-4">
        <ul className="flex flex-col gap-4 w-full">
          <li className="p-2 bg-rose-200 rounded-lg text-slate-800 border border-rose-300 shadow-md">
            ...
            <p className="text-rose-500">This is a simple JSX paragraph.</p>
          </li>
